...
class _TraCuuDiaDiemUIState extends State<TraCuuDiaDiemUI> {
  ...
  void initState() {
    ...
    if(_checkDD != 1){
      _traCuuDiaDiemBloc.traCuuDD(banKinh: _banKinh,maLoaiDanhMuc:_maLoaiDanhMuc,pageNum: _pageNum);
    }else{
      _traCuuDiaDiemBloc.traCuuDD1(banKinh: _botMess!.first.custom!.data!.banKinh,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Tra cứu địa điểm $_tenDM'),centerTitle: true,),
      body: StreamBuilder(
        stream: _traCuuDiaDiemBloc.traCuuDiaDiem.stream,
        builder: (context, AsyncSnapshot<List<TraCuuDiaDiemModels>> snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                return ListViewLoadMore(
                  ...
                  itemBuilder: (context, index) {
                    final TraCuuDiaDiemModels traCuuDiaDiem =_traCuuDiaDiem![index];
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      ...
                                      onTap:()=>launch('tel://${traCuuDiaDiem.soDienThoai}'),
                                      child: Text(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => _launchURL(traCuuDiaDiem.website!),
                                      child: Text(
                                        traCuuDiaDiem.website ?? ' Website hiện tại chưa được cập nhập',
                                        style: const TextStyle(
                                            color: Colors.blue,
                                            fontStyle: FontStyle.normal,
                                            fontSize: 15.0),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => openMapsSheet(traCuuDiaDiem.viDo!, traCuuDiaDiem.kinhDo!, traCuuDiaDiem.tenCoQuan!),
                                      child: Text(
                                        traCuuDiaDiem.diaChi ?? ' Địa chỉ hiện tại chưa được cập nhập' ,
                                        style: const TextStyle(
                                            color:  Colors.blue,
                                            fontStyle: FontStyle.normal,
                            ...
                            if (_traCuuDiaDiem![index].distance != 0)   const Divider(),
                            if (traCuuDiaDiem.distance != 0) Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${ NumberFormat("###", "en_US").format(traCuuDiaDiem.distance)}m ' ,
                                    style: const TextStyle(
                                        color: Colors.red,
                                        fontStyle: FontStyle.normal,
                                        fontSize: 15.0),
